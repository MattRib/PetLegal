                ...
                <div class="col-md-9 mb-md-0 mb-5">
                    ...
                    <form action="cont.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="md-form mb-0">
                                    <input type="text" autofocus placeholder="Seu Nome" name="nome_contato" id="contact-name" class="form-control">
                                </div>
                            </div>
                            <!-- Grid column -->
                            ...
                            <div class="col-md-6">
                                <div class="md-form mb-0">
                                    <input type="text" placeholder="Seu email" name="email_contato" id="contact-email" class="form-control">
                                </div>
                            </div>
                            <!-- Grid column -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="md-form mb-0">
                                    <input type="text" placeholder="Assunto" name="ass_contato" id="contact-Subject" class="form-control">
                                </div>
                            </div>
                            <!-- Grid column -->
